...
<head>
    ...
    <?php if (
        isset($rutas['logo_fichajes']) &&
        isset($rutas['logo_fichajes_web']) &&
        file_exists($rutas['logo_fichajes'])
    ): ?>

        <link
            rel="stylesheet"
            href="<?= htmlspecialchars($rutas['logo_fichajes_web']) ?>?v=<?= filemtime($rutas['logo_fichajes']) ?>"
        >
